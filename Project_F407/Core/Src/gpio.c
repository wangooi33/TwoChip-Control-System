...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BLDC_SD_GPIO_Port, BLDC_SD_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, BEEP_Pin|BDC_SD_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : BLDC_SD_Pin */
  GPIO_InitStruct.Pin = BLDC_SD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BLDC_SD_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : KEY2_Pin KEY4_Pin KEY5_Pin */
  ...
  /*Configure GPIO pin : BDC_SD_Pin */
  GPIO_InitStruct.Pin = BDC_SD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(BDC_SD_GPIO_Port, &GPIO_InitStruct);
